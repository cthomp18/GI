...
class KDTreeNode {
   public: 
      ...
      CUDA_NO_INLINE CUDA_CALLABLE void locatePhotons(glm::vec3 pt, Photon** locateHeap, volatile float * volatile mInv, int numPhotons, float *shF, int *shI);
      //__device__ __noinline__ void locatePhotons(glm::vec3 pt, Photon** locateHeap, volatile float * volatile mInv, int numPhotons, float *shF, int *shI);
