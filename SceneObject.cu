...
CUDA_CALLABLE SceneObject::SceneObject() {
...
void SceneObject::copyData(SceneObject *o) {
   pigment = o->pigment;
   translateVector = o->translateVector;
   rotateVector = o->rotateVector;
   scaleVector = o->scaleVector;
   ...
   indexRefraction = o->indexRefraction;
   photonReflectance = o->photonReflectance;
   photonRefractance = o->photonRefractance;
   dropoff = o->dropoff;
   
   //checkCollision = NULL;
   
   type = o->type;
   if (type == 0) { printf("what the fuck why is it a sphere"); }
